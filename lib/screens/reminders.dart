                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => NoteView(notes[index]),
                          ),
                        );
                      },
                      onDoubleTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                NoteEdit(NoteMode.Editing, notes[index]),
                          ),
                        );
                      },
                      onLongPress: () {
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => NoteEdit(NoteMode.Adding, null)));
          },
...
class _NoteTime extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Text(_time, style: TextStyle(color: Colors.grey.shade600));
  }
}
